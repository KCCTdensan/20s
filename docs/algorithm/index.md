...
```
数が小さい順に並んでいる配列において，右端と左端を決めた時に，xはその配列の右端と左端の真ん中の値よりも大きいか
```
流れとしては入力例1を例としてあげると次のようになります．
...
この時真ん中の値である5はx以上なので，答えは少なくとも5よりも右側には存在しないことが分かる．
よって答えの上限である右端を真ん中まで持っていく．
...
この時の真ん中の値である3はx以上であるため，答えの上限である右端を真ん中まで持っていく．
...
この時，右端と左端の位置の差が1(右端と左端の間に値が存在しない)なのでここて探索を終了します．

この時の右端が答えを満たす最小の数，左端が答えを満たさない最大の数もなります．
